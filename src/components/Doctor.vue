...
export default {
  ...
  methods: {
    getApi: function(medicalIssue) {
      fetch('https://api.betterdoctor.com/2016-03-01/doctors?query='+ 'cancer'+'&location=45.5231%2C-122.6765%2C%205&user_location=45.5231%2C-122.6765&skip=0&limit=20&user_key=' + this.apiKey)
      .then(response => {
